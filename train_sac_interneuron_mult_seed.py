...
for seed in seed_list:
    ...
    opt_a = optim.Adam(actor.get_optimizer_params(1e-4), lr=3e-4)
    ...
    norm_hist = sac.train_model(env, num_episodes, batch_size, start_steps, updates_per_step, seed, 
    ...
    c.plot_smoothness_vs_distance(traj, action, save_path=seed_dir)
    ...
    c.plot_spectral_norms(norm_hist, save_path=seed_dir)